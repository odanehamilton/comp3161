...
<form class="form" action="login.php" method="post">
  ...
  <br/><br/>
  <button type="submit" class="btn btn-default btn-lg btn-block" name="login">Login</button>
  </div><!-- center block -->
</form> 
...
if(isset($_POST['login'])) {
    ...
    $password = $_POST['password'];
     ...
     $result = mysql_query("SELECT * FROM account WHERE email = '$email_add' AND password = '$password'"); 
